      ...
      {loading ? (
        <div className="space-y-8">
          {[1, 2].map((i) => (
            <div key={i} className="grid sm:grid-cols-8 gap-4 animate-pulse">
              <div className="sm:col-span-2 h-24 rounded" style={{ backgroundColor: 'var(--skeleton)' }} />
        ...
        <motion.div variants={sectionVariants}>
          <ProjectCard
            ...
            description="A modern portfolio built with the MERN stack, featuring an admin panel for content management."
            link="#"
            imageUrl=""
