  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        ...
        <div className="pt-2">
          <p className="text-xs text-slate-500 mb-2">
            Upload your resume PDF. Visitors can download it directly from your
            site.
          </p>
          <FileUpload
            label="Resume PDF"
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs font-medium text-teal-400 hover:text-teal-300 transition"
            >
              <Plus size={14} /> Add Link
            </button>
          </div>
        ...
        {status.message && (
          <p
            className={`text-sm ${status.type === "success" ? "text-teal-400" : "text-red-400"}`}
          >
            {status.message}
          </p>
        )}
